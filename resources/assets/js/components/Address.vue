<template>
  <div class="row">
    <div class="col-md-2">
      <h3>List Sale Garages</h3>
      <div class="card my-1" v-for="garage in garages" :key="garage.id">
        <div class="card">
          <img class="card-img-top" :src="`../img/photos/${garage.images[0].name}`" height="200">
          <div class="card-body">
...
export default {
  ...
  methods: {
    ...
    fetchGarages() {
      axios.get(`/api/address/${this.address}`).then( res => {
